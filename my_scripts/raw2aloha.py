...
def process_single_video(i, video_dir, output_dir, actions, states, timestamps, error_eps, target_size=(224, 224)):
...
def main():
    ...
    parser.add_argument('--hdf5_path', type=str, default='/mnt/sda/lerobot/data/pnp_coke_raw/trainable_data.hdf5',
                      help='Input HDF5 file path')
    parser.add_argument('--video_dir', type=str, default='/mnt/sda/lerobot/data/pnp_coke_raw',
                      help='Input video directory')
    parser.add_argument('--output_dir', type=str, default='/mnt/sda/lerobot/data/pnp_coke_sim',
    ...
    parser.add_argument('--end_key', type=int, default=183, help='End key')
