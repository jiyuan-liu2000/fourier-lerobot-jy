...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='/mnt/sda/lerobot/data/pnp-clamp',
                      help='Input video directory')
    parser.add_argument('--output_dir', type=str, default='/mnt/sda/lerobot/data/pnp-clamp_sim',
